# Semester3-IndividualProject-PetPal
...
npm run bdd:test -- --env apiBaseUrl=http://localhost:8081/backend
```
...
```
cd existing_repo
git remote add origin https://git.fhict.nl/I529672/semester3-individualproject-petpal.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fhict.nl/I529672/semester3-individualproject-petpal/-/settings/integrations)
